 ...
 * 4.建议2步骤在Application的初始化中调用;<br>
 * 5.在不再使用时调用{@link #release()}释放资源，由于全局唯一实例，此方法不必须
 *
 * @author Hein
 */
public class FastTube {

    private static final String TAG = "FastTube";
     ...
     * @see TubeResponse
     */
    public TubeResponse connectSyncStream(String url, TubeOptions opt) {
        try {
